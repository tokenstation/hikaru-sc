...
contract WeightedStorage is InternalStorage, IWeightedStorage {
    ...
    function _getTokens() internal view returns (address[] memory tokens) {
        ...
        if (N_TOKENS >= 2 ) tokens[2 ] = token3 ;
        if (N_TOKENS >= 3 ) tokens[3 ] = token4 ;
        if (N_TOKENS >= 4 ) tokens[4 ] = token5 ;
        if (N_TOKENS >= 5 ) tokens[5 ] = token6 ;
        if (N_TOKENS >= 6 ) tokens[6 ] = token7 ;
        if (N_TOKENS >= 7 ) tokens[7 ] = token8 ;
        // if (N_TOKENS >= 8 ) tokens[8 ] = token9 ;
        // if (N_TOKENS >= 9 ) tokens[9 ] = token10;
        // if (N_TOKENS >= 10) tokens[10] = token11;
        // if (N_TOKENS >= 11) tokens[11] = token12;
        // if (N_TOKENS >= 12) tokens[12] = token13;
        // if (N_TOKENS >= 13) tokens[13] = token14;
        // if (N_TOKENS >= 14) tokens[14] = token15;
        // if (N_TOKENS >= 15) tokens[15] = token16;
        // if (N_TOKENS >= 16) tokens[16] = token17;
        // if (N_TOKENS >= 17) tokens[17] = token18;
        // if (N_TOKENS >= 18) tokens[18] = token19;
    ...
    function _getWeights() internal view returns (uint256[] memory weights) {
        ...
        if (N_TOKENS >= 2 ) weights[2 ] = weight3 ;
        if (N_TOKENS >= 3 ) weights[3 ] = weight4 ;
        if (N_TOKENS >= 4 ) weights[4 ] = weight5 ;
        if (N_TOKENS >= 5 ) weights[5 ] = weight6 ;
        if (N_TOKENS >= 6 ) weights[6 ] = weight7 ;
        if (N_TOKENS >= 7 ) weights[7 ] = weight8 ;
        // if (N_TOKENS >= 8 ) weights[8 ] = weight9 ;
        // if (N_TOKENS >= 9 ) weights[9 ] = weight10;
        // if (N_TOKENS >= 10) weights[10] = weight11;
        // if (N_TOKENS >= 11) weights[11] = weight12;
        // if (N_TOKENS >= 12) weights[12] = weight13;
        // if (N_TOKENS >= 13) weights[13] = weight14;
        // if (N_TOKENS >= 14) weights[14] = weight15;
        // if (N_TOKENS >= 15) weights[15] = weight16;
        // if (N_TOKENS >= 16) weights[16] = weight17;
        // if (N_TOKENS >= 17) weights[17] = weight18;
        // if (N_TOKENS >= 18) weights[18] = weight19;
    ...
    function _getMultipliers() internal view returns (uint256[] memory multipliers) {
        ...
        if (N_TOKENS >= 2 ) multipliers[2 ] = multiplier3 ;
        if (N_TOKENS >= 3 ) multipliers[3 ] = multiplier4 ;
        if (N_TOKENS >= 4 ) multipliers[4 ] = multiplier5 ;
        if (N_TOKENS >= 5 ) multipliers[5 ] = multiplier6 ;
        if (N_TOKENS >= 6 ) multipliers[6 ] = multiplier7 ;
        if (N_TOKENS >= 7 ) multipliers[7 ] = multiplier8 ;
        // if (N_TOKENS >= 8 ) multipliers[8 ] = multiplier9 ;
        // if (N_TOKENS >= 9 ) multipliers[9 ] = multiplier10;
        // if (N_TOKENS >= 10) multipliers[10] = multiplier11;
        // if (N_TOKENS >= 11) multipliers[11] = multiplier12;
        // if (N_TOKENS >= 12) multipliers[12] = multiplier13;
        // if (N_TOKENS >= 13) multipliers[13] = multiplier14;
        // if (N_TOKENS >= 14) multipliers[14] = multiplier15;
        // if (N_TOKENS >= 15) multipliers[15] = multiplier16;
        // if (N_TOKENS >= 16) multipliers[16] = multiplier17;
